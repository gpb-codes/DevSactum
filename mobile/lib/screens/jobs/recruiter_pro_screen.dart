...
class RecruiterProScreen extends StatelessWidget {
  const RecruiterProScreen({super.key});
          ...
          child: Column(
            ...
            children: [
              const Padding(
                ...
                child: Text('Membresía Reclutador', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, letterSpacing: -0.5)),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(20, 0, 20, 16),
                child: Text('Encuentra al talento perfecto', style: TextStyle(color: Colors.grey[500], fontSize: 14)),
              ),
              Expanded(
                child: ListView(
                  ...
                  children: [
                    _PlanCard(
                      ...
                      price: 'Gratis',
                      features: ['Publicar 1 oferta/mes', 'Búsqueda básica', 'Postulaciones ilimitadas'],
                      popular: false,
                    ...
                    _PlanCard(
                      name: 'Pro Recruiter',
                      price: '\$49/mes',
                      features: ['Ofertas ilimitadas', 'Smart Match IA', 'Dashboard analytics', 'Perfil de empresa destacado', 'Soporte prioritario'],
                      popular: true,
                    ...
                    _PlanCard(
                      ...
                      price: '\$99/mes',
                      features: ['Todo lo de Pro', 'API de reclutamiento', 'Múltiples usuarios', 'White label', 'Dedicated account manager'],
                      popular: false,
